#!/usr/bin/env python3
"""Run ONE problem of sciknoweval through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/sciknoweval"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one sciknoweval problem via TrustedRouter")
