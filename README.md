...
**Paper:** https://arxiv.org/abs/2406.09098v2

The Scientific Knowledge Evaluation benchmark is inspired by the profound principles outlined
in the “Doctrine of the Mean” from ancient Chinese philosophy. This benchmark is designed to
assess LLMs based on their proficiency in Studying Extensively, Enquiring Earnestly, Thinking
Profoundly, Discerning Clearly, and Practicing Assiduously. Each of these dimensions offers a
unique perspective on evaluating the capabilities of LLMs in handling scientific knowledge.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/sciknoweval`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/sciknoweval) |
| Group | Knowledge |
| Total samples | 70,196 |
...
- `direct_url` — `https://drive.google.com/uc?id={file_id}` (pinned)
- `huggingface` — `hicai-zju/SciKnowEval` (pinned)
